...
export function About() {
    ...
    const handleContactClick = async () => {
        try {
            await invoke('open_external_url', { url: 'https://multium-meet.zackriya.com/#about' });
        } catch (error) {
    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                <div className="mb-3">
                    <Image
                        ...
                        alt="Multium Meet Logo"
                        width={64}
                        height={64}
                        className="mx-auto"
                    />
                </div>
                {/* <h1 className="text-xl font-bold text-gray-900">Multium Meet</h1> */}
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes Multium Meet different</h2>
