...
const HOMEBREW_PATHS = [
  '/opt/homebrew/var/multium-meet/meeting_minutes.db',  // Apple Silicon (M1/M2/M3)
  '/usr/local/var/multium-meet/meeting_minutes.db',      // Intel Macs
];
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Previous Multium Meet Installation Detected!
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            We found an existing database from your previous Multium Meet installation (Python backend version).
          </p>
